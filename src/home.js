...
const Home = () => {
  ...
  return (
    <div  style={sectionStyle} className="h-screen">
        {/*Nav*/}
        <div  className="w-screen container ">
          <div className="w-full flex items-center justify-between">
            <a className="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
              Investing<span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">Guru</span>
            </a>
        ...
        {/*Main*/}
        <div className="container  md:pt-36  flex flex-wrap flex-col md:flex-row items-center">
          {/*Left Col*/}
          <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            <h1 className="my-4 text-3xl md:text-5xl text-white opacity-75 font-bold leading-tight text-center md:text-left">
              Want more traffic? 
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">
                InvestingGuru shows you 
              </span>
            </h1>
            <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left">
              how to win the game of SEO. Just type in a domain or a keyword to get started
            </p>
          </div>
          {/*Right Col*/}
          <div className="w-full xl:w-4/4 p-12 overflow-hidden">
          <form
            onSubmit={onsearch}
            className="bg-orange-500 flex items-center w-1/2 p-2 rounded overflow-hidden  shadow-xl z-10"
          >
            <input
